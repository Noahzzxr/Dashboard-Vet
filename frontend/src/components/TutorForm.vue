...
watch(() => props.tutor, syncForm, { deep: true })
onMounted(syncForm)
...
<template>
  <div class="form-container">
    <h3 class="form-title">{{ tutor ? 'Editar Tutor' : 'Novo Tutor' }}</h3>
    ...
    <form @submit.prevent="submitForm" class="clinic-form">
      ...
      <div class="form-row">
        <div class="form-group col-6">
          ...
          />
          <span v-if="errors.cpf" class="error-msg">{{ errors.cpf }}</span>
        </div>
      ...
      <div class="form-group">
        ...
        <input 
          ...
          :class="{ 'has-error': errors.endereco }"
        />
